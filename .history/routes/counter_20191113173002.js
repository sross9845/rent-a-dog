...
router.get('/', (req, res) => {
    ...
    User.find({} , (err, users) => {
        ...
        for (let i=0; i < myDogNameList.length; i++) {
            ...
            if (myDogNameList[i] === result[i] || myDogNameList[i] === result[iterator] || myDogNameList[i] === result[i + 1] || myDogNameList[i] === result[i + 2] || myDogNameList[i] === result[i + 3] || myDogNameList[i] === result[i + 4] || myDogNameList[i] === result[iterator - 1] || myDogNameList[i] === result[iterator -2] || myDogNameList[i] === result[iterator -3] || myDogNameList[i] === result[iterator -4] || myDogNameList[i+1] === result[iterator -3] || myDogNameList[i+1] === result[iterator -4])
