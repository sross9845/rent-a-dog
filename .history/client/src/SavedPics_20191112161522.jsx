...
class SavedPics extends Component {
    ...
    render() { 
        if (this.state.dogList) {
            ...
            var mappedDogs = this.state.dogList.map((ele, id) => <form onSubmit={this.handleSubmit}><div className='container'><p key={id} className='dogName'>{ele.name}<br /><img src={ele.photo} className='imageClass'></img></p></div>
