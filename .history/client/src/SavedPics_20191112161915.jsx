...
class SavedPics extends Component {
    ...
    render() { 
        if (this.state.dogList) {
            ...
            var mappedDogs = this.state.dogList.map((ele, id) => <div className='container'><form onSubmit={this.handleSubmit} className='formStyle'><p key={id} className='dogName'>{ele.name}<br /><img src={ele.photo} className='imageClass'></img></p><br />
