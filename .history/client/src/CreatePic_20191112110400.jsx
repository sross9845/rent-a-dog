            ...
            var mappedDogs = this.state.dogList.animals.map((ele, id) => {
                if(ele.photos.length > 0) {
                    return (  
                        ...
                        <input type="hidden" name="contact" value={ele.contact.email} onChange={this.handleChange}/>
                        <input type="hidden" name="contact" value={ele.contact.phone} onChange={this.handleChange}/>
                        <input type="hidden" name="contact" value={ele.contact.email} onChange={this.handleChange}/>
